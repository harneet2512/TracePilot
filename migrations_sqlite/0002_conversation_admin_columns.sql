...
ALTER TABLE conversations ADD COLUMN IF NOT EXISTS model_config_json text;
ALTER TABLE conversations ADD COLUMN IF NOT EXISTS retrieval_config_json text;
