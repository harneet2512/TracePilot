      ...
      <div className="p-6 max-w-3xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure how TracePilot syncs your Google Drive content
            </CardDescription>
          </CardHeader>
        ...
        {foldersLoading ? null : folders && folders.length > 0 ? (
          <Card>
            <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Folder selection isn't available for this account. TracePilot will index all accessible files.
          </p>
        )}
        ...
        <div className="flex justify-end gap-3">
          <Button variant="outline" asChild>
            <Link href="/admin/connectors">Cancel</Link>
          </Button>
          <Button
