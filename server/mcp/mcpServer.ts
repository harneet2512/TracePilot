/**
 * MCP Server - Model Context Protocol server for TracePilot
 * 
 * This module implements an MCP server that exposes TracePilot as tools and resources,
      ...
      tools: [
        {
          ...
          description: "Chat with TracePilot agent. Returns answer with citations and optional action draft.",
          inputSchema: {
            type: "object",
            properties: {
              query: {
        ...
        {
          name: "tracepilot.action_execute",
