...
async function handleDeepPath(
  ...
  try {
    ...
    const allChunks = await storage.getActiveChunksBounded(parseInt(process.env.RETRIEVAL_MAX_CANDIDATES_SQLITE || "1200", 10));
    ...
    const systemPrompt = `You are TracePilot voice assistant. Answer concisely based on the context.
